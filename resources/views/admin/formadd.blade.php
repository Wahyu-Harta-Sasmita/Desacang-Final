<x-sidebar-layout>
    ...
    <div class="bg-white p-6 rounded shadow mb-6">
        ...
        <form action="{{ route('formadd.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-6">
            @csrf
            ...
            <div>
                ...
                <select id="jenis_bantuan" name="jenis_bantuan" class="w-full p-2 border border-gray-300 rounded focus:outline-none">
                    <option value="">Pilih Jenis Bantuan</option>
                    <option value="PKH" {{ old('jenis_bantuan') == 'PKH' ? 'selected' : '' }}>PKH</option>
                    <option value="KIS" {{ old('jenis_bantuan') == 'KIS' ? 'selected' : '' }}>KIS</option>
                    <option value="KIP" {{ old('jenis_bantuan') == 'KIP' ? 'selected' : '' }}>KIP</option>
                    <option value="PBI" {{ old('jenis_bantuan') == 'PBI' ? 'selected' : '' }}>PBI</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select id="desa" name="desa" class="w-full p-2 border border-gray-300 rounded focus:outline-none">
                    ...
                    <option value="Desa Bungkulan" {{ old('desa') == 'Desa Bungkulan' ? 'selected' : '' }}>Desa Bungkulan</option>
                    <option value="Desa Temukus" {{ old('desa') == 'Desa Temukus' ? 'selected' : '' }}>Desa Temukus</option>
                </select>
            </div>
